		 ...
		 stage('deploy to tomcat') {
		     ...
		     steps {
		       script {
                ...
                sh "curl -v -u ${mycred} -T ${pom.artifactId}-${pom.version}.${pom.packaging} http://ec2-100-26-167-86.compute-1.amazonaws.com:8081/manager/text/deploy?path=/${pom.artifactId}&update=true"
	            }
             }
		  }
        }
