pipeline {
	...
	environment {
        ...
        NEXUS_URL = "ec2-18-207-137-162.compute-1.amazonaws.com:8081"
		 ...
		 stage('deploy to tomcat') {
		     ...
		     steps {
		       script {
                ...
                sh "curl -v -u ${mycred} -T ${pom.artifactId}.${pom.packaging} http://ec2-54-237-117-37.compute-1.amazonaws.com:8081/manager/text/deploy?path=/${pom.artifactId}&update=true"
	           	    }
		        }
	         }
          }
